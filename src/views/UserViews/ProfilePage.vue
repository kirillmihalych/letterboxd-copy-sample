...
// [x] Я хочу отслеживать фильмы, что я посмотрел и оценивать их
// [x] Сохранять фильмы, что хочу посмотреть.
...
// ===========КОНКРЕТНЫЕ-ЗАДАНИЯ==================================
// [__] Сделать slot дырку в search-module, всунув туда multi-search-bar, что уже есть в navbar, и поиск только по films для добавления в листы
// [__] Сделать логику добавление film в лист и настроить пользовательский опыт отображения фильмов в листе, когда фильм редакутируется (Loading & Errors). Дроп-даун должен закрываться по добавлению фильма, значит query должен чиститься.
// [__] Добавить возможность убрать фильм из листа на странице ManageeListView
// [__] Добавить возможность очистить все добавленые фильмы из листа, нужна будет модалка с подтверждением
// [__] Добавить возможность удалить лист на странице ManagaListView, обязательно с подтверждением с модалкой
// [__] Добавить возможность удалить лист на profile-page, обязательно с подтверждением с модалкой
...
// [__] Добавить на индивидуальную страницу фильма все взаимодействия с фильмом (тагл фаворит, тагл вотчлист, тагл в кастомный лист)
// [__] Изменить отображение фильмов в листе, использовать ууже существующую карту
// [__] Отладить макет
// [__] Протестировать приложение в деплое
// ========================================================
